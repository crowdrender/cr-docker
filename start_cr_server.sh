...
start_server() {
	...
	/usr/local/blender/blender -b -noaudio --python /root/.config/blender/2.81/scripts/addons/crowdrender/src/py_3_7/serv_int_start.py -- -t "server_int_proc"
}
