...
start_server (){
	...
	/usr/local/blender/blender -b -noaudio --python /root/.config/blender/2.79/scripts/addons/crowdrender/src/py_3_5_3/serv_int_start.py -- -ct "$token" -t "server_int_proc"
}
